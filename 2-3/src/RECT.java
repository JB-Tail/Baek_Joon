...
public class Main {
   ...
   public static void main(String[] args) 
   {
      ...
      if (inRect(sx1,sy1,100,100,200,200)||inRect(sx2,sy2,100,100,200,200)||inRect(sx1,sy2,100,100,200,200)||inRect(sx2,sy1,100,100,200,200)){System.out.println("Yes, two rectangles are collided.");} // 넷중 하나라도 참이면
              else if(inRect(100,100,sx1,sy1,sx2,sy2) && inRect(100,200,sx1,sy1,sx2,sy2) && inRect(200,100,sx1,sy1,sx2,sy2) && inRect(200,200,sx1,sy1,sx2,sy2)){System.out.println("Yes, two rectangles are collided.");} //아예 넘는경우를 대비해서
